...
// When using a lexical arrow function, if you only have one parameter there is no need for parens around it. However, if you use any more than one parameter, they need parens.
rawData.sort((a,b) => {
